...
// @ts-ignore
import { optimize as optimizeWithSvgo } from "svgo/dist/svgo.browser.js";
...
import { isDistanceSmaller } from "./is-distance-smaller";
...
export const optimize = memoize((value: string) =>
